    ...
    <div className="bg-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <p className="text-gray-700 mb-8 leading-relaxed">
                In today's competitive landscape, standing still is the surest
                way to moving backward. Our{" "}
                <span className="font-bold">
                  Business Consulting & Growth Strategy
                </span>{" "}
                service is designed to be the catalyst for your next phase of
                expansion and profitability. We don't just offer advice - we
                partner with you to implement bold, measurable growth
                initiatives.
              </p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed">
                      We dissect your current market position and develop a
                      robust strategy for penetrating{" "}
                      <span className="font-semibold">new markets</span> and
                      acquiring{" "}
                      <span className="font-semibold">high-value clients.</span>{" "}
                      This includes everything from detailed market segmentation
                      to creating effective, targeted sales campaigns that drive
                      your top line.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed">
                      We analyze your product/service offerings and establish
                      the most efficient and profitable{" "}
                      <span className="font-semibold">
                        distribution channels.
                      </span>{" "}
                      Whether you need to streamline your current network or
                      establish entirely new routes to market, we ensure your
                      offerings reach customers efficiently and effectively.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed">
                      Our ultimate goal is tangible financial impact. We focus
                      on strategies that directly lead to increased{" "}
                      <span className="font-semibold">revenue</span> and an
                      expanded{" "}
                      <span className="font-semibold">market share</span> within
                      your industry, ensuring your growth is sustained and
                      strategically sound.
                    </p>
                  </div>
                </div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="relative bg-white rounded-3xl p-8 md:p-16 max-w-6xl mx-auto">
            ...
            <p className="text-gray-700 text-center mb-12 leading-relaxed max-w-4xl mx-auto">
              To remain competitive, manufacturers must continually evaluate and
              upgrade their production processes. We call this service
              Manufacturing Process & Investment Optimization as it clearly
              focuses on technical benefits and cost savings.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
              ...
              <div className="bg-[#E0F2F1] p-8 rounded-2xl">
                ...
                <p className="text-sm text-gray-700 leading-relaxed">
                  We analyze your existing manufacturing processes and identify
                  opportunities to migrate to more efficient alternatives. These
                  migrations can be critical for yielding significant cost
                  benefits (e.g., lower material usage, faster cycle times) and
                  realizing key technical benefits (e.g., improved product
                  quality, tighter tolerances, or new material capabilities).
                </p>
              </div>
              ...
              <div className="bg-[#E0F2F1] p-8 rounded-2xl">
                ...
                <p className="text-sm text-gray-700 leading-relaxed">
                  Before committing to new machinery or equipment, you need
                  confidence in the return on investment. We rigorously evaluate
                  whether proposed capex expenditures will deliver tangible
                  improvements—lower operating costs, fewer breakdowns, or
                  enhanced yield. Our analysis ensures that capital decisions
                  are data-backed and strategically sound.
                </p>
              </div>
            </div>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="container mx-auto max-w-6xl">
          ...
          <p className="text-gray-700 text-center mb-12 leading-relaxed max-w-4xl mx-auto">
            Every business faces hurdles, but it's the speed and effectiveness
            with which they are solved that dictates long-term success. Our{" "}
            <span className="font-bold">
              Business Problem Solving & Transformation
            </span>{" "}
            service offers a structured, systematic approach to tackling your
            most complex operational, market, and financial challenges.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
              ...
              <div className="flex gap-6 items-start">
                <p className="text-sm text-gray-700 leading-relaxed flex-1">
                  Our team takes a systematic approach to diagnostic and solve
                  business challenges across every function—be it operational
                  bottlenecks, inefficient Marketing and reporting, declining
                  Sales and Marketing performance, critical Cost Position
                  issues.
                </p>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
              ...
              <div className="flex gap-6 items-start">
                <p className="text-sm text-gray-700 leading-relaxed flex-1">
                  We actively scout for the latest AI and technology solutions
                  that can be seamlessly integrated into your operations into a
                  Smart Factory. We identify, evaluate, and help integrate
                  systems that drive predictive maintenance, optimize resource
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
              ...
              <div className="flex gap-6 items-start">
                <p className="text-sm text-gray-700 leading-relaxed flex-1">
                  We implement transformative changes by re-engineering
                  processes, modernizing systems, and deploying solutions that
                  not only fix the immediate issue but also future-proof your
                  business against recurrence, leading to sustainable
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
              ...
              <div className="flex gap-6 items-start">
                <p className="text-sm text-gray-700 leading-relaxed flex-1">
                  We are committed to delivering practical, actionable solutions
                  that result in measurable improvements in efficiency,
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-gray-600 text-center max-w-3xl mx-auto mb-12">
            Cost optimization is non-negotiable for manufacturers aiming for a
            competitive edge. Our Strategic Sourcing & Supply Chain Consulting
            service provides expert guidance to dramatically reduce material and
            component costs while building a resilient, future-proof supply
            chain.
          </p>
            ...
            <div>
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-600 mt-2 text-sm leading-relaxed">
                  We specialize in resourcing projects by identifying and
                  developing high-quality, reliable alternative supply sources
                  in low-cost countries. For components or assemblies currently
                  sourced from high-cost regions (like Europe or the USA), we
                  manage the entire migration process—from initial supplier
                  vetting to qualification and stable production handover.
                </p>
              </div>
