                    ...
                    <div className="max-w-6xl mx-auto px:4 sm:px-6">
                        ...
                        <div className="mb-8">
                            ...
                            <p className="text-gray-600 mt-4 leading-relaxed">
                                The consulting practice at <span className="font-semibold text-gray-900">MechStrat Global</span> is led by an industry professionals with over <span className="font-semibold text-gray-900">17+ years</span> of cross-functional experience across manufacturing, AI & Advanced Technology solutions.
                            </p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-12 mb-12 items-center bg-[#E7F5F6]">
                            ...
                            <div className="order-1 px-2 md:order-2">
                                ...
                                <ul className="space-y-3 text-gray-700">
                                    ...
                                    <li className="flex items-start"><span className="text-gray-900 mr-3">•</span><span>Investment Casting.</span></li>
                                    <li className="flex items-start"><span className="text-gray-900 mr-3">•</span><span>Precision Machining.</span></li>
                                    <li className="flex items-start"><span className="text-gray-900 mr-3">•</span><span>Laser Cladding.</span></li>
                                    <li className="flex items-start"><span className="text-gray-900 mr-3">•</span><span>Surface Treatments.</span></li>
                                    <li className="flex items-start"><span className="text-gray-900 mr-3">•</span><span>Rubber Processing Machines.</span></li>
                                    <li className="flex items-start"><span className="text-gray-900 mr-3">•</span><span>Food Processing equipment.</span></li>
                                    <li className="flex items-start"><span className="text-gray-900 mr-3">•</span><span>Warehouse Automation.</span></li>
                                </ul>
                        ...
                        <div className="grid md:grid-cols-2 gap-8 md:gap-12 mb-12 p-8 rounded-xl items-center bg-[#E7F5F6] p-6 md:p-8 rounded-xl">
                            ...
                            <div className="order-1">
                                ...
                                <ul className="space-y-3 text-gray-700">
                                    <li className="flex items-end"><span className="text-gray-900 mr-3">•</span><span>Al-Driven Manufacturing Solutions.</span></li>
                                    <li className="flex items-end"><span className="text-gray-900 mr-3">•</span><span>Predictive Analytics for Production & Sourcing.</span></li>
                                    <li className="flex items-end"><span className="text-gray-900 mr-3">•</span><span>Data-Driven Process Improvement.</span></li>
                                    <li className="flex items-end"><span className="text-gray-900 mr-3">•</span><span>Digital Smart Factory Solutions.</span></li>
                                    <li className="flex items-end"><span className="text-gray-900 mr-3">•</span><span>Advanced Process Automation & Robotics.</span></li>
                                </ul>
                                <button className="mt-8 text-teal-600 font-semibold flex items-center gap-2 hover:gap-3 transition-all hover:animate-[bounce_1s_ease-in-out]">
                                    Know More <ArrowRight size={18} />
                                </button>
                        ...
                        <div className="bg-white p-6 rounded-lg">
                            <p className="text-gray-700">
                                <span className="font-semibold text-gray-900">+ Functions:</span> Production, Process Engineering, Application Engineering,
                                Business Development, Sales, Costing, and Strategy.
                            </p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-12 mb-12 bg-[#E7F5F6] mt-4">
                            ...
                            <div className="order-1 px-2 md:order-2">
                                ...
                                <ul className="space-y-3 text-gray-700">
                                    ...
                                    <li className="flex items-start"><span className="text-gray-900 mr-3 mt-1">•</span><span>Industrial Engineering.</span></li>
                                    <li className="flex items-start"><span className="text-gray-900 mr-3 mt-1">•</span><span>HVAC & Thermal Systems.</span></li>
                                    <li className="flex items-start"><span className="text-gray-900 mr-3 mt-1">•</span><span>Aerospace & Defense.</span></li>
                                    <li className="flex items-start"><span className="text-gray-900 mr-3 mt-1">•</span><span>Firearms.</span></li>
                                    <li className="flex items-start"><span className="text-gray-900 mr-3 mt-1">•</span><span>Medical Devices & Equipment.</span></li>
                                </ul>
                                <button className="mt-8 text-teal-600 font-semibold flex items-center gap-2 hover:gap-3 transition-all hover:animate-[bounce_1s_ease-in-out]">
                                    Know More <ArrowRight size={18} />
                                </button>
            ...
            >
                <ChevronRight className="text-white" size={22} />
                        ...
                        <div className="mt-12">
                            <p className="text-gray-700 leading-relaxed max-w-4xl">
                                We believe that true transformation happens when business intelligence meets industrial expertise, and{" "}
                                <span className="font-semibold text-gray-900">MechStrat Global</span> was founded to make that synergy possible
                ...
                <footer className="bg-[#1695A3] py-8 px-6 transition-all duration-700 ease-in-out">
                    <div className="container mx-auto text-center">
                        <p className="text-white text-sm mb-2 animate-fadeIn">© 2025 · MechStrat Global. All rights reserved.</p>
